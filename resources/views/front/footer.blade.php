                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="footer-block clearfix">
                                <p class="clearfix">
                                    <a class="logo" href="index.html" title="Admag - Responsive magazine HTML Template"
                                       rel="home">
                                        AD <span>MAG</span>
                                    </a><!-- .logo -->
                                </p>
                                ...
                                <p class="description">
                                    You are a part of the Rebel Alliance and a traitor! Take her away! You are a part of
                                    the Rebel Alliance and a traitor! Take her away! Don't underestimate the Force. Hey,
