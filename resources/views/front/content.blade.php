...
<head>
    ...
    <script
            ...
            publisher: "c653dddc-e16d-453e-a904-8ab2756a1365",
            doNotHash: false,
            doNotCopy: false,
            hashAddressBar: true
        });</script>
    ...
    <script type='text/javascript'>
        googletag.cmd.push(function () {
            var sidebarad = googletag.sizeMapping().addSize([1280, 800], [
                [160, 600],
                [120, 600],
                [336, 280]
                        ...
                        <footer class="post-meta">
                            <div class="tags-wrapper">
                                <ul class="tags-widget clearfix">
                                    ...
                                    <?php
                                    if ($content->tagged !== null) {
                                        $tagss = '';
                                        foreach ($content->tagged as $keyword) {
                                            $tagss[] = $keyword->tags->tag;
                                        }
                                        ...
                                        if (count($tagss) <= 5) {
                                            ...
                                            for ($i = 0; $i < 5; $i++) {
                                                echo '<li><a href="/tags/' . $tagss[$i] . '">' . $tagss[$i] . '</a></li>';
                                ...
                                <div class="post-nav-wrapper clearfix">
                                    <div class="col-md-6 omega">
                                        <div class="previous-post">
                                            ...
                                            <a href="/{{$previous->id}}/{{$previous->perm_url}}"
                                               class="post-nav-title">{{$previous->feed_title}}</a>
                                        </div>
                                    </div>
                                    @if(count($next)>0)
                                ...
                                <div class="col-md-6">
                                    <article class="news-block small-block">
                                        ...
                                        @if(count($relate->newsfeed->feed_category) > 0)
                                            <a href="/category/{{$relate->newsfeed->feed_category[0]->category->category}}"
                                               class="category">
                                        ...
                                        <header class="news-details">
                                            ...
                                            <p class="simple-share">
                                                <span class="article-date"><i
                                                            class="fa fa-clock-o"></i>{{human_time_diff($relate->newsfeed->created_at)}}</span>
                                            </p>
                                        </header>
                                    </article>
                                </div>
                                    ...
                                    @else
                                        <article class="widget-post clearfix">
                                            ...
                                            <header>
                                                ...
                                                <p class="simple-share">
                                                    <span><i class="fa fa-eye"></i> {{$lat->read_counter}} views</span>
                                                </p>
                                            </header>
                                        </article>
                                    @endif
                    ...
                    <div class="widget categorywidget">
                        ...
                        <ul>
                            @foreach($categories as $categorie)
                                <li>
                                    <a href="/category/{{$categorie->category->category}}">{{$categorie->category->category}}
                                        <span
