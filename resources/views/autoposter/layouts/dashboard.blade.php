        ...
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
                ...
                <ul class="nav hidden-xs" id="lg-menu">
                    ...
                    <li><a href="{{url('/add-facebook-user')}}"><i class="glyphicon glyphicon-user"></i> Add New Facebook User</a></li>
                    <li><a href="{{url('/link-facebook-account')}}"><i class="glyphicon glyphicon-list-alt"></i> Link to
                            Facebook</a>
                    </li>
                    <h4>Facebook Groups</h4>
                    <li class="nav-divider"></li>
                    <li><a href="{{('admin/add_user')}}"><i class="glyphicon glyphicon-list-alt"></i> Add Group</a>
                    </li>
                </ul>
                <!-- tiny only nav-->
            </div>
